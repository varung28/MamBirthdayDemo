...
VkResult ScenePradnya::initialize(void)
{
    // // function prototypes
...
VkResult ScenePradnya::resize(int width, int height)
{
...
VkResult ScenePradnya::update(void)
{
    VkResult vkResult = VK_SUCCESS;
...
void ScenePradnya::uninitialize(void)
{
    // code
    // INSERT_NEW_LINE_IN_LOG_FILE(gpFile);
    fprintf(gpFile, "===================================\n");
...
VkResult ScenePradnya::createVertexBuffer(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createUniformBuffer(void)
{
    // function prototypes
...
VkResult ScenePradnya::updateUniformBuffer(bool bSky)
{
    ...
    if (bSky)
    {
        myUniformData.modelMatrix = glm::scale(glm::mat4(1.0), glm::vec3(3.0f + 8.999998f, 3.0f + 0.500000f, 1.0f)) * glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 1.000000f, -5.0f + -11.300007f)); // (Perspective Change 2) : Translation
    }
    else
    {
...
VkResult ScenePradnya::updateColorVertexBuffer(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createShaders(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createDescriptorSetLayout(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createPipelineLayout(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createDescriptorPool(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createDescriptorSet(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::createPipeline(void)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
...
VkResult ScenePradnya::buildCommandBuffers(VkCommandBuffer &commandBuffer)
{
    // variable declarations
    VkResult vkResult = VK_SUCCESS;
