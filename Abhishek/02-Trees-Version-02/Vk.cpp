...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(
        WS_EX_APPWINDOW,
        szAppName,
        TEXT("Tree For Gokhale Madam's Birthday"),
...
VkResult createVertexBuffer(void)
{
    ...
    vkResult = createVertexBuffer_trees();
    if (vkResult != VK_SUCCESS)
        fprintf(gpFile, "%s() => createVertexBuffer_trees() Failed : %d !!!\n", __func__, vkResult);
    else
        fprintf(gpFile, "%s() => createVertexBuffer_trees() Succeeded\n", __func__);
...
VkResult updateUniformBuffer(void)
{
    ...
    // Code
    vkResult = updateUniformBuffer_trees();
    if (vkResult != VK_SUCCESS)
    {
        fprintf(gpFile, "%s() => updateUniformBuffer_trees() Failed : %d !!!\n", __func__, vkResult);
        return vkResult;
    }
